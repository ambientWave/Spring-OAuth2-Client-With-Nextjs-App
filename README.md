...
<img width="1919" height="942" alt="login" src="https://github.com/user-attachments/assets/fe85d1ef-dbf9-4932-94d0-f9d98c4bcd5b" />

## Authentication Workflow in Spring Security

The following explains the authentication workflow executed inside the code of this application. There are essentially three main workflows at play here:

### 1. The Core Security Setup ([SecurityConfig.java](./oauth2Client/src/main/java/com/ambientwave/oauth2Client/security/SecurityConfig.java))
...
### 2. The OAuth2 Login Workflow ([OAuth2AuthenticationSuccessHandler.java](./oauth2Client/src/main/java/com/ambientwave/oauth2Client/security/OAuth2AuthenticationSuccessHandler.java))
...
### 3. The Local Login/Register Workflow ([AuthController.java](./oauth2Client/src/main/java/com/ambientwave/oauth2Client/controllers/AuthController.java))
...
### 4. Authenticating Subsequent API Requests ([JwtAuthenticationFilter.java](./oauth2Client/src/main/java/com/ambientwave/oauth2Client/security/JwtAuthenticationFilter.java))
